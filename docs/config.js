/* Configuración del deploy. Completar los dos valores y volver a publicar.
   Ver README.md → "Pasos manuales". */
window.PEDIDOS_CONFIG = {
  /* URL del Web App de Apps Script, terminada en /exec */
  apiUrl:   'https://script.google.com/macros/s/AKfycbzukXbmtZoEtbqyyd-KO6KftZLaS53-YuRV2mTrKThcLzUB_7BPiYM1tIeFAGMTJRGf/exec',
